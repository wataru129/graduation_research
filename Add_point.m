...
N_sparse        = floor((1-(C/C_total))*per_clusta+0.5); %Number of sparse area
N_good          = per_clusta - N_sparse - 3;  %Number of good area
%%%%%%%%%%%%%          Initial setting         %%%%%%%%%%%%%%
...
for c_index =1:clusta
    ...
    add_point(:,:,c_index)=[add_point(:,:,c_index) add_temp  x_pso(:,c_index)];
